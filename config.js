...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/PfTsSuz.jpeg'
module.exports = {
  ...
  alivepic: process.env.ALIVE_IMG || 'https://i.imgur.com/PfTsSuz.jpeg',
  alivemsj: process.env.ALIVE_MSJ || '*Arslan king Assalam o Alaikum frends My name is Arslan Akram   .if you can use bot then subcribe My Youtobe Channale [ TECHNICAL ARSLAN ] https://www.youtube.com/@TechnicalHackersarslan  My contect number is +923493436993 Thanks😍😍😍',
